//Written August 16, 2001 by Bruce McLean
//for Denise Battles
//Copyright 2001
//T. Bruce McLean
//19 Northlake Drive
...
public class Aternary1 extends Applet implements ActionListener
{
  ...
  class DrawOn extends Canvas
  {
    ...
    {
		double sum=0.0;int bd, rd=17,//blue diam red diameter
		tsum=0;
		...
		for (int i=0;i<taskcount;++i)
		{
			...
			g.fillOval(25-bd/2+(int)(2*task[i][1]/slope+service/100.0*length+0.5),
              ...
              g.fillOval(25-rd/2+(int)(2*item[1]/slope+service/100.0*length+0.5),
                    225-rd/2-2*item[1],rd,rd);
		      g.setColor(Color.green);
