...
/**
 * Defines the default view of a node: a circle.
 * 
 * @author Emil Iacob
 *
 */
public class JGraphCircleView extends VertexView {
	public static final int RADIUS = 8;
	
	public static transient JGraphCircleRenderer renderer = new JGraphCircleRenderer();
	
	public JGraphCircleView() {
		super();
	}
	
	public JGraphCircleView(Object cell) {
		super(cell);
	}
	...
	public static class JGraphCircleRenderer extends VertexRenderer {
