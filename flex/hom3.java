...
public class hom3 extends JApplet
...
It also returns the number of equivalence classes of pats.
The 2+8 has (9)(1) classes, the 5+5 has (2)(2) classes, and the 8+2 has (9)(1) classes*/
...
// reference variables
    ...
    {    //layout and container
      ...
      c.add(DLabel); c.add(DInput);
       c.add(fLabel); c.add(fOuts);
       c.add(NLabel); c:add(NOuts);
       c.add(clearButton);
    }
